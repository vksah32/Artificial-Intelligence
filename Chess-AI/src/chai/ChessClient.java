...
//		moveMaker[Chess.BLACK] = new AIMoveMaker(new AlphaBetaAI());
		moveMaker[Chess.BLACK] = new AIMoveMaker(new FasterAlphaBetaAI());
...
//		moveMaker[Chess.WHITE] = new AIMoveMaker(new MiniMaxAI());
		moveMaker[Chess.WHITE] = new AIMoveMaker(new FasterAlphaBetaAI());
...
//			System.out.println("mover is "+game.position.getToPlay());
			if(game.position.isTerminal()){
//				System.out.println("is mate man");
